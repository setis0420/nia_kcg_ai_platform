# -*- coding: utf-8 -*-
"""
V10 Inertia-Aware Transformer - 지역별 학습
============================================
- 특정 지역 폴더 지정하여 학습
...
사용법:
    ...
    python run_train_v10_region.py --region 울산 --epochs 100
    python run_train_v10_region.py --data_dir "경로/지역폴더"
"""
...
# 기본 설정
BASE_DATA_DIR = r"K:\coding_project\NIA_선박항적예측프로그램\학습데이터_전처리\v10"
BASE_SAVE_DIR = r"K:\coding_project\NIA_선박항적예측프로그램\models\v10"
...
def train_model(region, data_dir, save_dir, device, max_chunks=None, epochs=50,
    ...
    """모델 학습"""
    print("=" * 60)
    print(f"V10 Inertia-Aware Transformer - {region} 100분 예측")
    print("=" * 60)
    ...
    for epoch in range(1, epochs + 1):
        ...
        if epoch % 5 == 0 or epoch == 1:
            ...
            print(f"  오차 - 평균: {avg_error:.2f}km, 30분: {error_30min:.2f}km, "
                  f"60분: {error_60min:.2f}km, 100분: {error_100min:.2f}km")
    ...
    return {
        ...
        'best_val_loss': best_val_loss,
        'avg_error': np.mean(errors),
        'error_100min': np.mean(errors[:, 99])
    }


def main():
    parser = argparse.ArgumentParser(
        description='V10 Inertia-Aware 100분 예측 모델 - 지역별 학습',
    ...
    parser.add_argument('--save_dir', type=str, default=None,
                        help='모델 저장 폴더 (기본: models/v10/지역명)')
    ...
    if args.data_dir:
        ...
        print("       사용 가능한 지역: python run_train_v10_region.py --list")
        return
